...
- Confirm the intended principle or pattern against its official definition (`web-search`, `fetch`; search fallback per the search strategy in `GEMINI.md`) so usage matches purpose
