...
- Run the touched package's tests or linter with the language's toolchain, per the execution rules in `GEMINI.md` (e.g. Python via `uv run`, TypeScript/JavaScript via `npx`)
